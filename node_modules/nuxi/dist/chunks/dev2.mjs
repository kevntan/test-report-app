...
/* build-hook-start *//*00001*/try { require('/Users/kevintjhia/.vscode/extensions/wallabyjs.console-ninja-1.0.330/out/buildHook/index.js').default({tool: 'nuxt'}); } catch(cjsError) { try { import('file:///Users/kevintjhia/.vscode/extensions/wallabyjs.console-ninja-1.0.330/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
